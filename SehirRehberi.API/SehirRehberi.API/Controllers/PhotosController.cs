...
namespace SehirRehberi.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IMapper mapper, IAppRepository appRepository, IOptions<CloudinarySettings> cloudinaryConfig)
        {
        ...
        public ActionResult AddPhotoForCity(int cityId,[FromForm]PhotoForCreationDto photoForCreationDto)
        {
            ...
            return BadRequest("Couldt not add the photo");
        }
